...
void WhiteAttack( int *x, int *y )
{
	...
	for (y_ = 1; y_ < 20; ++y_){
		for (x_ = 1; x_ < 17; ++x_){
			if (pan[x_][y_] == 2 && pan[x_ + 1][y_] == 2 && pan[x_ + 2][y_] == 2 && pan[x_ + 3][y_] == 2){
	...
	for (y_ = 1; y_ < 17; ++y_){
		for (x_ = 1; x_ < 20; ++x_){
			if (pan[x_][y_] == 2 && pan[x_][y_ + 1] == 2 && pan[x_][y_ + 2] == 2 && pan[x_][y_ + 3] == 2){
	...
	for (y_ = 1; y_ < 17; ++y_){
		for (x_ = 1; x_ < 17; ++x_){
			if (pan[x_][y_] == 2 && pan[x_ + 1][y_ + 1] == 2 && pan[x_ + 2][y_ + 2] == 2 && pan[x_ + 3][y_ + 3] == 2){
	...
	for (y_ = 1; y_ < 17; ++y_){
		for (x_ = 1; x_ < 17; ++x_){
			if (pan[x_][y_ + 3] == 2 && pan[x_ + 1][y_ + 2] == 2 && pan[x_ + 2][y_ + 1] == 2 && pan[x_ + 3][y_] == 2){
	...
	for (y_ = 1; y_ < 20; ++y_){
		for (x_ = 1; x_ < 15; ++x_){
			if (pan[x_][y_] == 1 && pan[x_ + 1][y_] == 1 && pan[x_ + 2][y_] == 1 && pan[x_ + 3][y_] == 1 && pan[x_ + 4][y_] == 0){
				*x = x_ + 4;
				*y = y_;
				pan[x_ + 4][y_] = 2;
				goto end;
	...
	for (y_ = 1; y_ < 15; ++y_){
		for (x_ = 1; x_ < 20; ++x_){
			if (pan[x_][y_] == 1 && pan[x_][y_ + 1] == 1 && pan[x_][y_ + 2] == 1 && pan[x_][y_ + 3] == 1 && pan[x_][y_ + 4] == 0){
				*x = x_;
				*y = y_ + 4;
				pan[x_][y_ + 4] = 2;
				goto end;
	...
	for (y_ = 1; y_ < 20; ++y_){
		for (x_ = 1; x_ < 15; ++x_){
			//O O O + O
			if (pan[x_][y_] == 1 && pan[x_ + 1][y_] == 1 && pan[x_ + 2][y_] == 1 && pan[x_ + 3][y_] == 0 && pan[x_ + 4][y_] == 1){
				*x = x_ + 3;
				*y = y_;
				pan[x_ + 3][y_] = 2;
				goto end;
			}
			else if (pan[x_][y_] == 1 && pan[x_ + 1][y_] == 0 && pan[x_ + 2][y_] == 1 && pan[x_ + 3][y_] == 1 && pan[x_ + 4][y_] == 1){
				*x = x_ + 1;
				*y = y_;
				pan[x_ + 1][y_] = 2;
				goto end;
	...
	for (y_ = 1; y_ < 15; ++y_){
		for (x_ = 1; x_ < 20; ++x_){
			// O O O + O
			if (pan[x_][y_] == 1 && pan[x_][y_ + 1] == 1 && pan[x_][y_ + 2] == 1 && pan[x_][y_ + 3] == 0 && pan[x_][y_ + 4] == 1){
				*x = x_;
				*y = y_ + 3;
				pan[x_][y_ + 3] = 2;
				goto end;
			}
			else if (pan[x_][y_] == 1 && pan[x_][y_ + 1] == 0 && pan[x_][y_ + 2] == 1 && pan[x_][y_ + 3] == 1 && pan[x_][y_ + 4] == 1){
				*x = x_;
				*y = y_ + 1;
				pan[x_][y_ + 1] = 2;
				goto end;
	...
	for (y_ = 1; y_ < 15; ++y_){
		for (x_ = 1; x_ < 15; ++x_){
			// O O O + O
			if (pan[x_][y_] == 1 && pan[x_ + 1][y_ + 1] == 1 && pan[x_ + 2][y_ + 2] == 1 && pan[x_ + 3][y_ + 3] == 0 && pan[x_ + 4][y_ + 4] == 1){
				*x = x_ + 3;
				*y = y_ + 3;
				pan[x_ + 3][y_ + 3] = 2;
				goto end;
			...
			// O + O O O
			else if (pan[x_][y_] == 1 && pan[x_ + 1][y_ + 1] == 0 && pan[x_ + 2][y_ + 2] == 1 && pan[x_ + 3][y_ + 3] == 1 && pan[x_ + 4][y_ + 4] == 1){
				*x = x_ + 1;
				*y = y_ + 1;
				pan[x_ + 1][y_ + 1] = 2;
				goto end;
	...
	for (y_ = 1; y_ < 15; ++y_){
		for (x_ = 1; x_ < 15; ++x_){
			//O O O + O
			if (pan[x_][y_ + 4] == 1 && pan[x_ + 1][y_ + 3] == 1 && pan[x_ + 2][y_ + 2] == 1 && pan[x_ + 3][y_ + 1] == 0 && pan[x_ + 4][y_] == 1){
				*x = x_ + 3;
				*y = y_ + 1;
				pan[x_ + 3][y_ + 1] = 2;
				goto end;
			}//O + O O O
			else if (pan[x_][y_ + 4] == 1 && pan[x_ + 1][y_ + 3] == 0 && pan[x_ + 2][y_ + 2] == 1 && pan[x_ + 3][y_ + 1] == 1 && pan[x_ + 4][y_] == 1){
				*x = x_ + 1;
				*y = y_ + 3;
				pan[x_ + 1][y_ + 3] = 2;
				goto end;
	...
	for (y_ = 1; y_ < 17; ++y_){
		for (x_ = 1; x_ < 17; ++x_){
			// O O + O +
			if (pan[x_][y_] == 1 && pan[x_ + 1][y_ + 1] == 1 && pan[x_ + 2][y_ + 2] == 0 && pan[x_ + 3][y_ + 3] == 1 && pan[x_ + 4][y_ + 4] == 0 && x_ < 16 && y_ < 16){
				*x = x_ + 2;
				*y = y_ + 2;
				pan[x_ + 2][y_ + 2] = 2;
				goto end;
	...
	for (y_ = 1; y_ < 20; ++y_){
		for (x_ = 1; x_ < 18; ++x_){
			if (pan[x_][y_] == 1 && pan[x_ + 1][y_] == 1 && pan[x_ + 2][y_] == 1){
				if (pan[x_ - 1][y_] == 2 || pan[x_ + 3][y_] == 2){
					continue;
				}
				if (pan[x_ - 1][y_] == 0 && x_ > 1){
					*x = x_ - 1;
	...
	for (y_ = 1; y_ < 18; ++y_){
		for (x_ = 1; x_ < 20; ++x_){
			if (pan[x_][y_] == 1 && pan[x_][y_ + 1] == 1 && pan[x_][y_ + 2] == 1){
				if (pan[x_][y_ - 1] == 2 || pan[x_][y_ + 3] == 2){
					continue;
				}
				if (pan[x_][y_ - 1] == 0 && y_>1){
					*x = x_;
	...
	for (y_ = 1; y_ < 18; ++y_){
		for (x_ = 1; x_ < 18; ++x_){
			if (pan[x_][y_] == 1 && pan[x_ + 1][y_ + 1] == 1 && pan[x_ + 2][y_ + 2] == 1){
				if (pan[x_ - 1][y_ - 1] == 2 || pan[x_ + 3][y_ + 3] == 2){
					continue;
				}
				if (pan[x_ - 1][y_ - 1] == 0 && x_ > 1 && y_ > 1){
					*x = x_ - 1;
	...
	for (y_ = 1; y_ < 18; ++y_){
		for (x_ = 1; x_ < 18; ++x_){
			if (pan[x_][y_ + 2] == 1 && pan[x_ + 1][y_ + 1] == 1 && pan[x_ + 2][y_] == 1){
				if (pan[x_ - 1][y_ + 3] == 2 || pan[x_ + 3][y_ - 1] == 2){
					continue;
				}
	...
	for (y_ = 1; y_ < 17; ++y_){
		for (x_ = 1; x_ < 17; ++x_){
			// O O + O +
			if (pan[x_][y_] == 2 && pan[x_ + 1][y_ + 1] == 2 && pan[x_ + 2][y_ + 2] == 0 && pan[x_ + 3][y_ + 3] == 2 && pan[x_ + 4][y_ + 4] == 0 && y_ < 16){
				*x = x_ + 2;
				*y = y_ + 2;
				pan[x_ + 2][y_ + 2] = 2;
				goto end;
	...
	for (y_ = 1; y_ < 17; ++y_){
		for (x_ = 1; x_ < 17; ++x_){
			...
			// + O + O O
			else if (pan[x_ - 1][y_ + 4] == 0 && pan[x_][y_ + 3] == 2 && pan[x_ + 1][y_ + 2] == 0 && pan[x_ + 2][y_ + 1] == 2 && pan[x_ + 3][y_] == 2 && x_>1 && x_ < 16){
				*x = x_ + 1;
				*y = y_ + 2;
				pan[x_ + 1][y_ + 2] = 2;
				goto end;
